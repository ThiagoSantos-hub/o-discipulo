...
import {
  LayoutDashboard, Users, CreditCard, BookOpen, FolderOpen, Church, Heart, Users2, MessageCircle, Library, Star, Trophy, Gamepad2, Bell, DollarSign, BarChart3, FileText, Plug, Bot, Settings, User, LogOut,
} from 'lucide-react'
...
export function AdminSidebar() {
  return (
    <div className="w-72 bg-[#1C1C1C] border-r border-[#333333] h-full flex flex-col">
      ...
      <div className="p-4 border-t border-[#333333]">
        <button
          onClick={() => alert('Logout simulado (Fase 2)')}
